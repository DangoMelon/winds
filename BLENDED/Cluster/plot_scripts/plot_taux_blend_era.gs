...
'open /data/datos/ASCAT/ASCAT_CORR/climx_correc_dim_met2_16_19.ctl'
...
'define anom=taux.1-lterp(tx.2,taux.1)'
'define anom2=ave(anom,lat='latini',lat='latfin')'
'set yflip on'
'set lat 0'
'set clevs 'niveles
'set ccols 'colores
...
'set string 1 tl 6 0'
'draw string 0.38 0.2 Clim: 2008-2013 ERA Corrected'
