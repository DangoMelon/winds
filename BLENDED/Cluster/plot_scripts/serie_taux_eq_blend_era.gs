...
'open /data/users/service/PAGWEB2/ascat_blend/ctls/ascat_tau_clim_corrected_4yy.ctl'

outdir='../Output/'
name='serie_ataux_blend_eq_box_era'
...
****************************************************
'set t 'Nti' 'Nt
'define ataux=taux-lterp(taux.2,taux)'
...
'draw string 4.25 0.13 Source: CMEMS/CERSAT Blended Mean Wind   Processing: IGP   Clim: 2008-2013 ERA Corrected   Latest Data: 'day''month''year' '
